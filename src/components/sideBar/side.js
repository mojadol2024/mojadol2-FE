...
function Sidebar() {
  ...
  return (
    <div className="sidebar">
      <div className="logo" onClick={() => navigate('/InterviewMain')} style={{ cursor: 'pointer' }}>
  ...
  <li onClick={() => navigate('/SpellingCorrection')} style={{ cursor: 'pointer' }}>
    ...
    <FaUserCog size={20} style={{ marginRight: '10px' }} /> 개인정보 관리     {/*근데 애는 안쓰는? 형태만 있고 기능은 없는거 같긴한데 일단 페이지는 있어서 연결은 했어요 안쓸거면 지우면 될거같아요*/}
  </li> 
